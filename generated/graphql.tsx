...
export type CategoriesByLevelQueryVariables = Exact<{
  level?: InputMaybe<Scalars['Int']>;
}>;

export type CategoriesByLevelQuery = {
  __typename?: 'Query';
  categories?: {
    __typename?: 'CategoryCountableConnection';
    edges: Array<{
    ...
    products?: {
      ...
      edges: Array<{
        ...
        node: {
          ...
          defaultVariant?: { __typename?: 'ProductVariant'; sku?: string | null } | null;
        };
      }>;
    } | null;
  } | null;
...
export type AllCollectionsQuery = {
  ...
  collections?: {
    ...
    edges: Array<{
      __typename?: 'CollectionCountableEdge';
      node: { __typename?: 'Collection'; id: string; name: string; slug: string };
    }>;
  } | null;
};
  ...
  menus?: {
    ...
    edges: Array<{
      ...
      node: {
        __typename?: 'Menu';
        name: string;
        items?: Array<{ __typename?: 'MenuItem'; id: string; name: string }> | null;
      };
    }>;
  } | null;
};
...
export type ProductsByMainCategoryQueryVariables = Exact<{
  id: Scalars['ID'];
  after?: InputMaybe<Scalars['String']>;
}>;

export type ProductsByMainCategoryQuery = {
  __typename?: 'Query';
  products?: {
    __typename?: 'ProductCountableConnection';
    totalCount?: number | null;
...
export type BestSellersQueryVariables = Exact<{ [key: string]: never }>;
...
export const CategoriesByLevelDocument = gql`
...
/**
 * __useCategoriesByLevelQuery__
 *
 * To run a query within a React component, call `useCategoriesByLevelQuery` and pass it any options that fit your needs.
 * When your component renders, `useCategoriesByLevelQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useCategoriesByLevelQuery(
  baseOptions?: Apollo.QueryHookOptions<CategoriesByLevelQuery, CategoriesByLevelQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<CategoriesByLevelQuery, CategoriesByLevelQueryVariables>(
    CategoriesByLevelDocument,
    options,
  );
}
export function useCategoriesByLevelLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    CategoriesByLevelQuery,
    CategoriesByLevelQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<CategoriesByLevelQuery, CategoriesByLevelQueryVariables>(
    CategoriesByLevelDocument,
    options,
  );
}
export type CategoriesByLevelQueryHookResult = ReturnType<typeof useCategoriesByLevelQuery>;
export type CategoriesByLevelLazyQueryHookResult = ReturnType<typeof useCategoriesByLevelLazyQuery>;
export type CategoriesByLevelQueryResult = Apollo.QueryResult<
  CategoriesByLevelQuery,
  CategoriesByLevelQueryVariables
>;
...
export function useAllCollectionsQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<AllCollectionsQuery, AllCollectionsQueryVariables>(
...
export function useAllCollectionsLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<AllCollectionsQuery, AllCollectionsQueryVariables>(
    AllCollectionsDocument,
    options,
  );
}
...
export type AllCollectionsQueryResult = Apollo.QueryResult<
  AllCollectionsQuery,
...
export const ProductsByCategoryDocument = gql`
  query productsByCategory(
    ...
    products(
      first: 20
      filter: { categories: [$id], price: { lte: $lte, gte: $gte } }
...
export function useProductsByCategoryQuery(
  baseOptions: Apollo.QueryHookOptions<ProductsByCategoryQuery, ProductsByCategoryQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ProductsByCategoryQuery, ProductsByCategoryQueryVariables>(
...
export function useProductsByCategoryLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ProductsByCategoryQuery, ProductsByCategoryQueryVariables>(
    ProductsByCategoryDocument,
    options,
  );
}
...
export type ProductsByCategoryQueryResult = Apollo.QueryResult<
  ...
  ProductsByCategoryQueryVariables
>;
export const ProductsByMainCategoryDocument = gql`
  query productsByMainCategory($id: ID!, $after: String) {
    products(first: 20, filter: { categories: [$id] }, after: $after) {
      pageInfo {
        hasNextPage
        endCursor
      }
...
/**
 * __useProductsByMainCategoryQuery__
 *
 * To run a query within a React component, call `useProductsByMainCategoryQuery` and pass it any options that fit your needs.
 * When your component renders, `useProductsByMainCategoryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useProductsByMainCategoryQuery({
 *   variables: {
 *      id: // value for 'id'
 *      after: // value for 'after'
 *   },
 * });
 */
export function useProductsByMainCategoryQuery(
  baseOptions: Apollo.QueryHookOptions<
    ProductsByMainCategoryQuery,
    ProductsByMainCategoryQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ProductsByMainCategoryQuery, ProductsByMainCategoryQueryVariables>(
    ProductsByMainCategoryDocument,
    options,
  );
}
export function useProductsByMainCategoryLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ProductsByMainCategoryQuery,
    ProductsByMainCategoryQueryVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ProductsByMainCategoryQuery, ProductsByMainCategoryQueryVariables>(
    ProductsByMainCategoryDocument,
    options,
  );
}
export type ProductsByMainCategoryQueryHookResult = ReturnType<
  typeof useProductsByMainCategoryQuery
>;
export type ProductsByMainCategoryLazyQueryHookResult = ReturnType<
  typeof useProductsByMainCategoryLazyQuery
>;
export type ProductsByMainCategoryQueryResult = Apollo.QueryResult<
  ProductsByMainCategoryQuery,
  ProductsByMainCategoryQueryVariables
>;
...
export function useProductByNameQuery(
  baseOptions?: Apollo.QueryHookOptions<ProductByNameQuery, ProductByNameQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ProductByNameQuery, ProductByNameQueryVariables>(
    ProductByNameDocument,
    options,
  );
}
export function useProductByNameLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ProductByNameQuery, ProductByNameQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ProductByNameQuery, ProductByNameQueryVariables>(
    ProductByNameDocument,
    options,
  );
}
...
export const FeaturedProductsDocument = gql`
  query featuredProducts {
    products(first: 5, sortBy: { direction: DESC, field: RATING }) {
      pageInfo {
        hasNextPage
        hasPreviousPage
      }
...
export function useFeaturedProductsLazyQuery(
...
export type FeaturedProductsQueryResult = Apollo.QueryResult<
  FeaturedProductsQuery,
  FeaturedProductsQueryVariables
>;
export const NewProductsDocument = gql`
  query newProducts {
    products(first: 10, sortBy: { direction: DESC, field: PUBLICATION_DATE }) {
      edges {
        node {
          id
          name
...
export function useNewProductsQuery(
  baseOptions?: Apollo.QueryHookOptions<NewProductsQuery, NewProductsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<NewProductsQuery, NewProductsQueryVariables>(NewProductsDocument, options);
}
export function useNewProductsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<NewProductsQuery, NewProductsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<NewProductsQuery, NewProductsQueryVariables>(
    NewProductsDocument,
    options,
  );
}
...
export type NewProductsQueryResult = Apollo.QueryResult<
  NewProductsQuery,
  NewProductsQueryVariables
>;
export const ProductsDocument = gql`
  query products(
    ...
    products(
      ...
      sortBy: { direction: $direction, field: $field }
      after: $after
      filter: { price: { lte: $lte, gte: $gte }, collections: $collection }
    ) {
      pageInfo {
        hasNextPage
        endCursor
...
export const BestSellersDocument = gql`
  query bestSellers {
    reportProductSales(period: THIS_MONTH, first: 8) {
      edges {
        node {
          id
          product {
...
export function useBestSellersQuery(
  baseOptions?: Apollo.QueryHookOptions<BestSellersQuery, BestSellersQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<BestSellersQuery, BestSellersQueryVariables>(BestSellersDocument, options);
}
export function useBestSellersLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<BestSellersQuery, BestSellersQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<BestSellersQuery, BestSellersQueryVariables>(
    BestSellersDocument,
    options,
  );
}
...
export type BestSellersQueryResult = Apollo.QueryResult<
  BestSellersQuery,
